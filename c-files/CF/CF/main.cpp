...
int main() {
    ...
    //    Output to file
    std::ofstream ff1("/Users/ju/Documents/Animation/firefly stuff/FF_JF/c-files/CF/phi_ext.txt");
    for(vector<double>::const_iterator i = phi_ext.begin(); i != phi_ext.end(); ++i) {
        ff1 << *i << '\n';}
    std::ofstream ff2("/Users/ju/Documents/Animation/firefly stuff/FF_JF/c-files/CF/phi.txt");
    for(vector<double>::const_iterator i = phase.begin(); i != phase.end(); ++i) {
        ff2 << *i << '\n';}
    std::ofstream ff3("/Users/ju/Documents/Animation/firefly stuff/FF_JF/c-files/CF/omegas.txt");
